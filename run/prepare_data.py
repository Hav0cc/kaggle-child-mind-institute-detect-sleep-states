...
SERIES_SCHEMA = {
    ...
    "anglez": pl.Float32,
    "enmo": pl.Float32,
    "anglez_diff": pl.Float32,
    "enmo_diff": pl.Float32,
    "anglez_diff_pct": pl.Float32,
    "enmo_diff_pct": pl.Float32,
}
...
# # Cleaned Data Version 2
# ANGLEZ_MEAN = -9.069571
# ANGLEZ_STD = 39.15796
# ENMO_MEAN = 0.042505
# ENMO_STD = 0.114257

# Cleaned Data Version 2.1
# ANGLEZ_MEAN = -9.172397
# ANGLEZ_STD = 39.072777
# ENMO_MEAN = 0.0431572
# ENMO_STD = 0.116973
...
def add_feature(series_df: pl.DataFrame) -> pl.DataFrame:
    series_df = (
        ...
        .with_columns(
            ...
            *to_coord(pl.col("timestamp").dt.minute(), 60, "minute"),
            ...
            anglez_diff=pl.col('anglez').diff().abs(),
            enmo_diff=pl.col('enmo').diff().abs(),
    ...
    series_df = series_df.with_columns(
        pl.col('anglez_diff').fill_null(strategy="zero"),
        pl.col('enmo_diff').fill_null(strategy="zero"),
        pl.col('anglez_diff_pct').fill_null(strategy="zero"),
        pl.col('enmo_diff_pct').fill_null(strategy="zero")
    )
